...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.headerContainer','data' => ['type' => 'complex','h1' => 'Список тегов','linkButton' => ''.e(route('tags.create')).'','buttonName' => '+ Добавить тег']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'complex','h1' => 'Список тегов','linkButton' => ''.e(route('tags.create')).'','buttonName' => '+ Добавить тег']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.index','data' => ['data' => $tags,'emptyList' => 'Теги отсутствуют','routeCardTitleLink' => 'tags.show','routeEditButton' => 'tags.edit','formClassName' => 'tagForm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($tags),'emptyList' => 'Теги отсутствуют','routeCardTitleLink' => 'tags.show','routeEditButton' => 'tags.edit','formClassName' => 'tagForm']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('components.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel7\resources\views/tags/index.blade.php ENDPATH**/ ?>