...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.headerContainer','data' => ['type' => 'simple','h1' => 'Добавить новый автомобиль']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'simple','h1' => 'Добавить новый автомобиль']); ?>
...
<?php endif; ?>
    ...
    <form id="carForm">
        ...
        <?php echo $__env->make('cars.form', ['isEdit' => false], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.buttonGroup','data' => ['class' => 'btn-primary','link' => ''.e(route('cars.index')).'','btnBack' => '← Назад к каталогу','btnSubmit' => 'Добавить автомобиль']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn-primary','link' => ''.e(route('cars.index')).'','btnBack' => '← Назад к каталогу','btnSubmit' => 'Добавить автомобиль']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('components.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel8\resources\views/cars/create.blade.php ENDPATH**/ ?>