<?php $__env->startSection('title', 'Редактирование данных автомобиля'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.headerContainer','data' => ['type' => 'simple','h1' => 'Редактирование данных автомобиля']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'simple','h1' => 'Редактирование данных автомобиля']); ?>
...
<?php endif; ?>
    ...
    <form id="carForm">
        ...
        <?php echo $__env->make('cars.form', ['isEdit' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.buttonGroup','data' => ['class' => 'edit-button','link' => ''.e(route('cars.index')).'','btnBack' => '← Назад к каталогу','btnSubmit' => 'Сохранить']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'edit-button','link' => ''.e(route('cars.index')).'','btnBack' => '← Назад к каталогу','btnSubmit' => 'Сохранить']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('components.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel8\resources\views/cars/edit.blade.php ENDPATH**/ ?>