<?php $__env->startSection('title', 'Добавить тег'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.headerContainer','data' => ['type' => 'simple','h1' => 'Добавить новый тег']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'simple','h1' => 'Добавить новый тег']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['label' => 'Название','name' => 'title','type' => 'text','placeholder' => 'Например: Красная цена']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Название','name' => 'title','type' => 'text','placeholder' => 'Например: Красная цена']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.buttonGroup','data' => ['class' => 'btn-primary','link' => ''.e(route('tags.index')).'','btnBack' => '← Назад к списку','btnSubmit' => 'Добавить тег']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn-primary','link' => ''.e(route('tags.index')).'','btnBack' => '← Назад к списку','btnSubmit' => 'Добавить тег']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('components.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel8\resources\views/tags/create.blade.php ENDPATH**/ ?>